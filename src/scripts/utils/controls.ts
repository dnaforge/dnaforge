            ...
            if (GLOBALS.hover) {
                ...
                if (intersects.length > 0 && this.pointerOnCanvas) {
                    ...
                    if (this.curMesh.getTooltip) {
                        this.context.addTooltip(this.intersection.point, this.curMesh.getTooltip(this.intersection));
                    }
                    if (this.prevMesh && this.prevMesh !== this.curMesh && this.prevMesh.onMouseOverExit) {
